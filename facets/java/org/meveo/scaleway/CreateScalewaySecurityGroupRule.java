...
public class CreateScalewaySecurityGroupRule extends Script{

    private static final Logger logger = LoggerFactory.getLogger(CreateScalewaySecurityGroupRule.class);
    ...
    public void execute(Map<String, Object> parameters) throws BusinessException {
        ...
        if (response.getStatus()<300) {
            ...
            try {
                ...
                logger.error("Error creating security rule : {} for security group : {}", rule.getUuid(), securityGroupUuid, e.getMessage());
            }
        }
    response.close();
    }
