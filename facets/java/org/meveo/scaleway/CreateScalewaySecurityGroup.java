...
public class CreateScalewaySecurityGroup extends Script {
    ...
    public void execute(Map<String, Object> parameters) throws BusinessException {
        ...
        if(securityGroup.getZone()==null) { // required
            throw new BusinessException("Invalid Security Group Zone");
        } else if(securityGroup.getName()==null) {
            throw new BusinessException("Invalid Security Group Name");
        }
        ...
        if (securityGroup.getServers() != null) {
            ...
            for (String serverId : securityGroup.getServers()){
                ...
                try {
                    ...
                    logger.error("Error retrieving Server : {} for security group : {}", serverId, securityGroup.getUuid(), e.getMessage());
                }
        ...
        if(securityGroup.getTags() != null) {
            ...
            for(String tag: securityGroup.getTags()) {
                tags.add(tag);
            }
            body.put("tags", tags);
        }
