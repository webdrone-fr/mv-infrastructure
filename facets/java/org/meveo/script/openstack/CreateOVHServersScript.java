...
public class CreateOVHServersScript extends Script {
    ...
    public void createServer(Credential credential, ServiceProvider openstack, Server server) throws BusinessException {
        ...
        if (server.getName() == null) {
            ...
            // Request
          	List<JsonObject> servers = openstackAPI.computeAPI("servers", credential.getToken(), resp, "post", "server");
            ...
            //if (responseStatus < 300) {
          	for (JsonObject serverObj : servers) {
                ...
                List<JsonObject> newServers = openstackAPI.computeAPI(urlServer, credential.getToken(), null, "get", "servers");
